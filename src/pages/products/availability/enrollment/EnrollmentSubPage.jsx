...
import EnrollmentSubPageHeader from './EnrollmentSubPageHeader';
...
const EnrollmentSubPage = () => {
  ...
  const loadTable = (paginationParam_, searchParam_) => {
    ...
    getProductAvailabilitiesApi(
      varValue('productAvailability.kind', 'corp'),
      params,
      onGetEnrollmentList,
      onFailEnrollmentList,
    );
  };

  const onGetEnrollmentList = (data) => {
...
export default EnrollmentSubPage;
