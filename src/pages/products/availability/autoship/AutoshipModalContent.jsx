      ...
      <Row gutter={[15, 0]}>
        ...
        <Col xs={24}>
          <div className={`${styles.inputContainer}`}>
            ...
            >
              <MultiSelect options={allProductsOption || []} optionFilterProp="label" />
            </Form.Item>
          </div>
        </Col>
      </Row>
...
export default AutoshipModalContent;
