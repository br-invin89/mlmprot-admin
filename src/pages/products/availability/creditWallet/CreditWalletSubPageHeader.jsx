...
import CreditWalletModalContent from './CreditWalletModalContent';
import styles from './CreditWalletSubPage.less';

const CreditWalletSubPageHeader = (props) => {
  return (
    <>
...
export default CreditWalletSubPageHeader;
