...
const UploadBenefits = () => {
  const props = {
    name: 'benefits',
    action: `${REACT_APP_API_SERVER}/api/admin/products/import/benefits`,
    accept: '.csv',
    headers: {
    ...
    onChange(info) {
      ...
      if (info.file.status === 'done') {
        message.success("Imported the product's benefits successfully");
      ...
      <Row>
        <Col span={24}>
          <h4 className={`${styles.title}`}>
            {t('pages.import.uploadBenefits', 'Upload Benefits')}
          </h4>
        </Col>
      </Row>
